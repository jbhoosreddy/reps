module.exports = {
  ...
  SET_ACTIVE_TAB: Symbol("SET_ACTIVE_TAB"),
  START_STRESS_TEST: Symbol("START_STRESS_TEST"),
  CLEAR_STRESS_TEST_OUTPUT: Symbol("CLEAR_STRESS_TEST_OUTPUT"),
  /* Constants */
  DIR_FORWARD: Symbol("DIR_FORWARD "),
  DIR_BACKWARD: Symbol("DIR_BACKWARD"),
  LS_EXPRESSIONS_KEY: "LS_EXPRESSIONS_KEY",
  TAB_CONSOLE: Symbol("TAB_CONSOLE"),
  TAB_STRESS_TEST: Symbol("TAB_STRESS_TEST")
};
